...
public class VistaAgenda {
    ...
    private void mostrarPenalizaciones(ArrayList<Penalizacion> lista) {
        ...
        for (int i = 0; i < lista.size(); i++) {
            totalMin += lista.get(i).getMinutosPerdidos();
        }
    ...
    private void filtrarPenalizacionesPorRango(ArrayList<Penalizacion> lista,
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            if (estaEnRango(pen.getFecha(), fechaInicio, fechaFin)) {
                ...
                totalMin += pen.getMinutosPerdidos();
                contador++;
            }
        }
    ...
    public void registrarPenalizacion(Estudiante estudiante) {
        ...
        // Entrada robusta: no se cae con NumberFormatException si el
        // usuario escribe texto en vez de un numero.
        int minutos = leerEnteroPositivo("  Minutos perdidos: ");
    ...
    // Pide un numero entero positivo (>0) y no continua hasta que sea valido.
