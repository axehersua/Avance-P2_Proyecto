...
public class MenuPrincipal {
    ...
    private void registrarTarea() {
        ...
        System.out.print("  Dificultad (1=facil, 5=muy dificil): ");
        int dificultad = Integer.parseInt(scanner.nextLine().trim());

        String id = "T" + String.format("%03d", estudiante.getTareas().size() + 1);
